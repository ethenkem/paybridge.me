...
namespace PayBridge.Migrations
{
    ...
    [Migration("20260517175446_AddPaymentTable")]
            ...
            modelBuilder.Entity("PayBridge.Features.Contracts.Milestone", b =>
                {
                    ...
                    b.HasIndex("PaymentId")
                        .HasDatabaseName("ix_milestones_payment_id");

                    b.ToTable("milestones", (string)null);
                });

            modelBuilder.Entity("PayBridge.Features.Payments.Models.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PayBridge.Features.Contracts.Milestone", b =>
                {
                    ...
                    b.HasOne("PayBridge.Features.Payments.Models.Payment", "Payment")
                        .WithMany()
                        .HasForeignKey("PaymentId")
                        .HasConstraintName("fk_milestones_payments_payment_id");
